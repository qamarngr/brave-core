...
TEST(FilRequestUnitTest, fil_estimateGas) {
  EXPECT_EQ(
      ...
      "GasEstimateMessageGas\",\"params\":[{\"From\":\"from_address\","
      "\"GasFeeCap\":\"gas_fee_cap\",\"GasLimit\":9223372036854775807,"
      "\"GasPremium\":\"gas_premium\",\"Method\":0,\"Nonce\":"
      "18446744073709551615,\"Params\":\"\",\"To\":\"to_address\",\"Value\":"
