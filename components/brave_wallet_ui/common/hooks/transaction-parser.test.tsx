  ...
  describe('check for sameAddressError', () => {
    describe.each([
      ...
      it(`should be defined when sender and ${toLabel} are same`, () => {
        const { result: { current: transactionParser } } = renderHook(() => useTransactionParser(mockNetwork), renderHookOptionsWithCustomStore(store))
  ...
  describe('check for insufficientFundsError', () => {
    describe.each([
      ...
      it('should be true when funds are insufficient for gas', () => {
        ...
        const { result: { current: transactionParser } } = renderHook(() => useTransactionParser(mockNetwork), renderHookOptionsWithCustomStore(customStore))
        //   mockNetwork,
        //   [{
        //     ...mockAccount,
        //     tokenBalanceRegistry: {
        ...
        const customStore = createStore(combineReducers({
          wallet: createWalletReducer({
            ...
            fullTokenList: [
              ...
              { ...mockERC20Token, contractAddress: mockTxData.baseData.to.toLowerCase() }
            ],
            accounts: [
              ...mockWalletState.accounts,
              {
    ...
    describe.each([
      ...
      it('should return missingGasLimitError if gas limit is zero or empty', () => {
        ...
        const mockTransactionInfo1 = {
          ...
          txDataUnion: {
            ...baseMockTransactionInfo.txDataUnion,
            ethTxData1559: {
